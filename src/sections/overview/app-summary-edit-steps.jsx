...
export function useAppSummaryForm(setSummaryDetails) {
...
export function AppSummaryEditStep({ setSummaryDetails, onComplete, startDate = DEFAULT_VALUES.start, endDate = DEFAULT_VALUES.end }) {
  const { onSubmit } = useAppSummaryForm(setSummaryDetails);
  ...
  const fields = [
    {
    ...
    },
      {
        ...
        options: uniqueEventOptions.map(event => ({ value: event.event_name, label: event.event_name })),
        checkbox: true,
        chip: true,
      },
      {
...
export function AppSummaryEditDialog({ setSummaryDetails, open, onClose, onComplete, startDate, endDate }) {
