        ...
        <Grid container columnSpacing={{ md: 3 }} alignItems="flex-start">
          ...
          <Grid xs={12} md={6} lg={5}>
            ...
            <m.div variants={varFade().inRight}>
              ...
              >
                הערכת שלנו היא הערכת המתקדמת והידידותית ביותר שתמצא בשוק, יש לנו תיעוד וידאו כדי לעזור לך להגדיר את האתר שלך בקלות, דוגמאות מותקנות מראש שאתה יכול לייבא בלחיצה אחת וכל דבר מאפשרויות הערכה לתוכן הדף ניתן לעריכה מהחזית. זו הערכה שאתה מחפש.
              </Typography>
            </m.div>
