...
import { _socials, _carouselsMembers } from '../../../../../../Desktop/vite-js/src/_mock'
      ...
      <Container component={MotionViewport} sx={{ textAlign: 'center', py: { xs: 10, md: 15 } }}>
        ...
        <m.div variants={varFade().inUp}>
          <Typography sx={{ mx: 'auto', maxWidth: 640, color: 'text.secondary' }}>
            מינימל יספק לך תמיכה אם יש לך בעיות כלשהן, צוות התמיכה שלנו יגיב בתוך יום ויש לנו גם תיעוד מפורט.
          </Typography>
        </m.div>
